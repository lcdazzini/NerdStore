...
namespace NerdStore.Vendas.Application.Queries.Services
{
	public class PedidoQueriesService : IPedidoQueriesService
    {
        private readonly IPedidoRepository _pedidoRepository;

        public PedidoQueriesService(IPedidoRepository pedidoRepository)
        {
